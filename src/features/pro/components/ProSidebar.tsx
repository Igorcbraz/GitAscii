...
export const ProSidebar: React.FC<ProSidebarProps> = ({
  ...
  const { t } = useI18n()
  const { mobileNavOpen, setMobileNavOpen } = useProNav()
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:sticky top-0 left-0 z-50 md:z-40 w-64 h-screen bg-[#080808] border-r border-white/[0.07] flex flex-col justify-between flex-shrink-0 select-none transition-transform duration-300 ease-in-out md:translate-x-0 ${
        ...
        <div className="p-4 space-y-6">
          <div className="flex items-center justify-between px-2 pt-1">
            ...
            <button
              type="button"
              onClick={() => setMobileNavOpen(false)}
              className="md:hidden p-1.5 rounded-lg text-[#7a7a7a] hover:text-white hover:bg-white/5 transition-colors cursor-pointer"
