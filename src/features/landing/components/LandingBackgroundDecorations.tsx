...
+----------------------------------+`}
      ...
      <span className="absolute top-[5%] left-[12%] font-jetbrains-mono text-sm text-signal-lime/30 select-none hidden md:block">+</span>
      <span className="absolute top-[10%] right-[14%] font-jetbrains-mono text-sm text-signal-lime/30 select-none hidden md:block">+</span>
      <span className="absolute top-[38%] left-[15%] font-jetbrains-mono text-sm text-signal-lime/30 select-none hidden md:block">+</span>
      <span className="absolute top-[44%] right-[12%] font-jetbrains-mono text-sm text-signal-lime/30 select-none hidden md:block">+</span>
      <span className="absolute top-[70%] left-[12%] font-jetbrains-mono text-sm text-signal-lime/30 select-none hidden md:block">+</span>
      <span className="absolute top-[76%] right-[16%] font-jetbrains-mono text-sm text-signal-lime/30 select-none hidden md:block">+</span>
    </div>
  )
}
