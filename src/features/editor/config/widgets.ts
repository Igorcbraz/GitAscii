...
export const WIDGET_CATALOG: WidgetCatalogItem[] = [
  ...
  {
    id: WIDGET_IDS.PEDRO_INSIGHTS_DOSSIER,
  ...
  {
    id: WIDGET_IDS.PEDRO_DEVELOPER_DNA,
    name: 'DNA',
    icon: Cpu,
  ...
  {
    id: WIDGET_IDS.PEDRO_CODING_VELOCITY,
...
export const WIDGET_FILTERS: WidgetFilterItem[] = [
  ...
  {
    id: 'pedrofnseca',
    labelKey: 'editor.sidebar.filter.pedrofnseca',
    defaultLabel: 'ASCII Premium Kit',
    icon: Terminal,
    match: (item) => item.category === WIDGET_CATEGORIES.PEDRO_FONSECA,
  },
  {
    id: 'external',
