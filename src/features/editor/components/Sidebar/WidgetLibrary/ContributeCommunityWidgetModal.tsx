...
interface ContributeCommunityWidgetModalProps {
  isOpen: boolean
  onClose: () => void
}

export function ContributeCommunityWidgetModal({
  isOpen,
  onClose,
}: ContributeCommunityWidgetModalProps) {
  ...
  const steps = [
    {
      icon: FolderPlus,
      title: t('editor.guide.community_widget.step1_title', '1. Onde adicionar seu Widget?'),
      description: t(
    ...
    {
      icon: Code2,
      title: t('editor.guide.community_widget.step2_title', '2. Como adicionar via Pull Request'),
      description: t(
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="font-inter-tight font-semibold text-body text-chalk">
                    {t('editor.guide.community_widget.title', 'Como Adicionar seu Próprio Widget')}
                  </h2>
                ...
                {currentStep === 0 && (
                  <div className="space-y-2.5">
                    <div className="p-3 rounded-md bg-void-black border border-graphite">
                      <p className="font-inter-tight text-caption font-semibold text-signal-lime mb-0.5">
                        {t('editor.guide.community_widget.step1_single_title', 'Apenas 1 Widget:')}
                      </p>
                      <p className="font-inter-tight text-caption text-ash">
                        {t(
                    ...
                    <div className="p-3 rounded-md bg-void-black border border-graphite">
                      <p className="font-inter-tight text-caption font-semibold text-[#ffa657] mb-0.5">
                        {t('editor.guide.community_widget.step1_kit_title', 'Kit com 2+ Widgets:')}
                      </p>
                      <p className="font-inter-tight text-caption text-ash">
                        {t(
