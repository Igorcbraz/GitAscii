...
const meta: Meta<typeof AsciiTextControls> = {
  title: 'Editor/Properties/AsciiTextControls',
  component: AsciiTextControls,
  tags: ['autodocs'],
  decorators: [
    (Story) => {
...
export default meta
type Story = StoryObj<typeof AsciiTextControls>
