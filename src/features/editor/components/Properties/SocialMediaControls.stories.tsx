...
const meta: Meta<typeof SocialMediaControls> = {
  title: 'Editor/Properties/SocialMediaControls',
  component: SocialMediaControls,
  tags: ['autodocs'],
  decorators: [
    (Story) => {
...
export default meta
type Story = StoryObj<typeof SocialMediaControls>
