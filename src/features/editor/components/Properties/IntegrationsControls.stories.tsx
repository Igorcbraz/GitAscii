...
const meta: Meta<typeof IntegrationsControls> = {
  title: 'Editor/Properties/IntegrationsControls',
  component: IntegrationsControls,
  tags: ['autodocs'],
  decorators: [
    (Story) => {
...
export default meta
type Story = StoryObj<typeof IntegrationsControls>
