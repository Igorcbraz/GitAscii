...
const mockRepos: GitHubRepo[] = [
  {
    id: 1,
    name: 'rest-api-C',
    full_name: 'octocat/rest-api-C',
    description: 'High performance REST API in C',
    html_url: 'https://github.com/octocat/rest-api-C',
  ...
  },
  {
    ...
    full_name: 'octocat/esp32-http-client',
    description: 'Embedded HTTP client for ESP32',
    html_url: 'https://github.com/octocat/esp32-http-client',
    stargazers_count: 25,
    forks_count: 5,
    language: 'C++',
    fork: false,
