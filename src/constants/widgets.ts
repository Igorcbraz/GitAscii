...
export const WIDGET_ALIASES: Readonly<Record<string, readonly string[]>> = {
  ...
  pedro: [
    WIDGET_IDS.PEDRO_PROFILE_CARD,
    WIDGET_IDS.PEDRO_DEV_SCORE,
    WIDGET_IDS.PEDRO_INSIGHTS_DOSSIER,
    WIDGET_IDS.PEDRO_DEVELOPER_DNA,
    WIDGET_IDS.PEDRO_CODING_VELOCITY,
  ],
  pedrofnseca: [
    WIDGET_IDS.PEDRO_PROFILE_CARD,
    WIDGET_IDS.PEDRO_DEV_SCORE,
  ...
  devscore: [WIDGET_IDS.PEDRO_DEV_SCORE],
  insights: [WIDGET_IDS.PEDRO_INSIGHTS_DOSSIER],
  dna: [WIDGET_IDS.PEDRO_DEVELOPER_DNA],
  developerdna: [WIDGET_IDS.PEDRO_DEVELOPER_DNA],
  velocity: [WIDGET_IDS.PEDRO_CODING_VELOCITY],
  codingvelocity: [WIDGET_IDS.PEDRO_CODING_VELOCITY],
} as const
