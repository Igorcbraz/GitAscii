...
export const TEMPLATE_PRESETS: Record<string, TemplatePreset> = {
  ...
  terminal: {
    ...
    layout: [
      ...
      },
      {
        ...
        config: { charset: 'dense', edgeEnhance: true, lockAspectRatio: true },
        locked: false,
        visible: true,
        zIndex: 2,
      },
  ...
  nord: {
    ...
    name: 'Nord Frost',
    description:
      'Arctic frost color palette with polar night cards, ice blue accents, and mountain badges.',
    colors: {
      background: '#2e3440',
  ...
  cyberpunk: {
    ...
    name: 'Cyberpunk Neon',
    description:
      'Futuristic neon aesthetic with electric magenta, cyan glows, and angular cut cards.',
    colors: {
      background: '#0c0c14',
  ...
  neobrutalism: {
    ...
    name: 'Neo Brutalism',
    description:
      'High-contrast design style featuring bold dark outlines and solid offset shadows.',
    colors: {
      background: '#fef08a',
