...
export function FeatureCard({ feature, index, className, ...props }: FeatureCardProps) {
	...
	return (
		...
		>
			...
			<div className="absolute top-2 left-2 text-graphite/40 font-mono text-[8px] pointer-events-none select-none group-hover:text-signal-lime/20 transition-colors duration-300">+</div>
			<div className="absolute top-2 right-2 text-graphite/40 font-mono text-[8px] pointer-events-none select-none group-hover:text-signal-lime/20 transition-colors duration-300">+</div>
			<div className="absolute bottom-2 left-2 text-graphite/40 font-mono text-[8px] pointer-events-none select-none group-hover:text-signal-lime/20 transition-colors duration-300">+</div>
			<div className="absolute bottom-2 right-2 text-graphite/40 font-mono text-[8px] pointer-events-none select-none group-hover:text-signal-lime/20 transition-colors duration-300">+</div>
