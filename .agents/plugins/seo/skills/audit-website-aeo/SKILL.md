...
- `prioritizedFixes`, `worstPages`, `coverage`, `heuristicIntelligenceSignals` — supporting context. The heuristic signals are a deterministic _prior_ — a sanity check, not the real evaluation.
