...
<ResponseField name="hideDecorations" type="boolean" default="false">
  When `true`, removes theme-specific corner elements (e.g. Dracula dots, Cyberpunk corner
  brackets).
</ResponseField>

<ResponseField name="animationType" type="AnimationType" default="none">
  Entrance animation: `none`, `fade-in`, `slide-up`, `slide-down`, `slide-left`, `slide-right`,
  `zoom-in`, `zoom-out`, `flip-x`, `flip-y`, `typewriter`, `glitch`, `scan-lines`.
</ResponseField>
