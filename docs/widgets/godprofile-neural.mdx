...
<ParamField
  ...
  default="{'Frontend': ['react', 'nextjs', 'tailwind'], 'Backend': ['nodejs', 'postgres', 'docker'], 'DevOps': ['git', 'github', 'linux']}"
>
  Categorized node layers. Each column renders vertical nodes and interconnects to subsequent
  columns.
</ParamField>
